...
import { APP_CONFIGS , environment } from '@env';
import { NotificationMessage , Notification , QuickNotification } from '../models/notification';
...
export class MessageNotifyService implements OnDestroy {
	...
	private api = ''.concat( environment.api , 'notification/' );
