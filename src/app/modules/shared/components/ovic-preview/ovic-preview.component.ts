...
import { Download , OvicDriveFile , OvicFileSever , OvicPreviewFileContent , OvicTinyDriveFile } from '@core/models/file';
...
export class OvicPreviewComponent implements OnInit {
	 ...
	 * *****************************************************/
	async loadAndShowFileContent( file : OvicFileSever | OvicDriveFile | OvicTinyDriveFile ) {
		this.loadingFail       = false;
		this.isLoadFileContent = false;
		this.download$         = null;
