...
import { Download , OvicDriveFile , OvicFileSever , OvicDocument , OvicMediaSources } from '@core/models/file';
...
export class OvicDownloadProgressComponent implements OnInit {
	...
	@Input() file : OvicFileSever | OvicDriveFile;
	...
	_file : OvicFileSever | OvicDriveFile | OvicDocument;
	...
	validateFile( file : OvicFileSever | OvicDriveFile ) {
