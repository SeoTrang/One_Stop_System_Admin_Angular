...
import { OvicDriveFile , OvicFileSever , OvicFileStore , OvicFileUpload , OvicDocument } from '@core/models/file';
...
export class OvicFileIconPipe implements PipeTransform {
	...
	transform( file : OvicFileSever | OvicFileStore | OvicDriveFile | OvicFileUpload | File | String | OvicDocument ) : string {
