...
import { OvicDocument , OvicDocumentDownloadResult , OvicDriveFile , OvicFileSever , OvicPreviewFileContent } from '@core/models/file';
...
export class MediaService {
	...
	tplDownloadFile( file : OvicFileSever | OvicDriveFile | OvicDocument ) : Promise<DownloadProcess> {
	...
	tplLoadFile( file : OvicFileSever | OvicDriveFile | OvicDocument ) : Promise<OvicDocumentDownloadResult> {
	...
	tplFileDetail( file : OvicFileSever | OvicDriveFile | OvicDocument ) : Promise<any> {
	...
	openFileManager( multiple = false ) : Promise<OvicFileSever[] | OvicDriveFile[]> {
	...
	openPersonalFileManager( settings? : FileExploreSettings ) : Promise<OvicFileSever[] | OvicDriveFile[]> {
		const modalOption                      = {
			scrollable  : true ,
			size        : 'xl' ,
